                ...
                case 1:
                    ...
                    switch (jenis) {
                        case 1:
                            ...
                            tokoJamTangan.tambahJamTangan(new JamAnalog(nama, tipe, ukuran, jumlah, harga, tipeMesin));
                            break;
                        case 2:
                            System.out.print("Tipe Display: ");
                            String tipeDisplay = sc.nextLine();
                            tokoJamTangan.tambahJamTangan(new JamDigital(nama, tipe, ukuran, jumlah, harga, tipeDisplay));
                            break;
                        default:
                        ...
                        if (indexUpdate >= 1 && indexUpdate <= tokoJamTangan.size()) {
                            ...
                            switch (jenisUpdate) {
                                case 1:
                                    ...
                                    tokoJamTangan.updateJamTangan(indexUpdate - 1, new JamAnalog(namaUpdate, tipeUpdate, ukuranUpdate, jumlahUpdate, hargaUpdate, tipeMesinUpdate));
                                    break;
                                case 2:
                                    System.out.print("Tipe Display: ");
                                    String tipeDisplayUpdate = sc.nextLine();
                                    tokoJamTangan.updateJamTangan(indexUpdate - 1, new JamDigital(namaUpdate, tipeUpdate, ukuranUpdate, jumlahUpdate, hargaUpdate, tipeDisplayUpdate));
                                    break;
                                default:
                                    System.out.println("Pilihan tidak valid");
                                    break;
