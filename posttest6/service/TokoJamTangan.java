...
public class TokoJamTangan {
    private final ArrayList<JamTangan> daftarJamTangan;
    ...
    public void updateJamTangan(int index, String nama, String tipe, int ukuran, int jumlah, int harga, String jenis, String tambahan) {
    ...
    public static int inputInteger(Scanner sc, String message) {
        int input = 0;
